...
@extends('layouts.semantic_nav')
@section('head')
<script language="JavaScript" src="/assets/loi/cos.js"></script>
<script language="JavaScript" src="/assets/loi/loiupload.js"></script>
<script type="text/javascript" src="/assets/loi/md5.js"></script>
<script type="text/javascript" src="/assets/loi/loiform.js"></script>
@endsection
...
<table class="ui sortable celled table fixed">
  ...
  <tbody>
          ...
          @else
              ...
              <td title="{!! $blade->showHtmlClass('vrgame',$val['game_category'] ,'text') !!}">{!! $blade->showHtmlClass('vrgame',$val['game_category'] ,'text') !!}</td>
              <td  title="{!! $blade->showHtmlClass('vrgame_tags',$val['game_tags'] ,'text') !!}">{!! $blade->showHtmlClass('vrgame_tags',$val["game_tags"] ,'text') !!}</td>
              <td class="dev_uid"></td>
...
<div class="ui modal modal-add">
  ...
  <div class="content">
    <form class="ui form " onsubmit="return false;">
      ...
      <div class="field">
      <label>游戏关键词</label>
      <input id="game_keywords" type="text" value="">
      </div>
      <div class="field">
      <label>搜索名称</label>
    ...
    {!! $blade->showHtmlClass('vrgame','','select') !!}
      ...
      <div class="field">
        <label>标签</label>
        <select  id="game_tags" name="game_tags" class="ui selection dropdown" multiple="">
    <option value="">请选择</option>
...
var game_device = $('#game_device').dropdown();
var game_platform = $('#game_platform').dropdown();
var game_lang = $('#game_lang').dropdown();
